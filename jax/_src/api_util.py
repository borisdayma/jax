...
def assert_no_intersection(static_argnames, donate_argnames):
  ...
  if out:
    raise ValueError("static_argnames and donate_argnames cannot intersect. "
                     f"Got static_argnames {static_argnames} and "
                     f"donate_argnames {donate_argnames} intersecting at {out}")
